...
// Function for displaying different sections on a single page
...
// Function for updating mybalance and tranfering money to other accounts
   ...
   if (enteredAmount==0 ){
    alert("Entered Amount not valid")
      ...
      if (myAccountBalance>=0){
        ...
        alert(`Successful Transaction !  Rs ${enteredAmount} is sent to ${enteredName}@email.com.`)
